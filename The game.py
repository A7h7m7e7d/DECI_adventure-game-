...
def inspect_the_scene():
    global score
    print_pause("After inspecting the crime scene, you found that the"
...
def searching_for_gun():
    global score
    print_pause("You found nothing. Maybe the murderer threw the weapon "
...
def examine_the_corpse():
    global score
    print_pause("After a thorough examination of the deceased individual, several"
                " significant findings emerged.")
    print_pause("Firstly, upon inspecting the victim's wallet, it was uncovered"
    ...
    print_pause("Secondly, a meticulous examination of the body revealed a bullet"
                " hole at the person's back, effectively ruling out the possibility of suicide and indicating that the cause of death was indeed a gunshot wound.")
    print_pause("This deduction strongly suggests the involvement of a firearm"
                " as the murder weapon.")
    print_pause("Lastly, an intriguing detail caught attention—the only "
...
def talking_with_the_sus():
    global score
    print_pause("The initial suspect in question is Wahid, "
    ...
    print_pause("Another individual present at the scene is identified as"
                " Cristena. She was not only a math teacher but also hails from"
                " France. When questioned about her knowledge of the deceased, she claims to "
    ...
    print_pause("Firstly, upon inspecting the victim's wallet, it was uncovered that he"
    ...
    print_pause("Secondly, a meticulous examination of the body revealed a bullet hole at the"
    ...
    print_pause("Lastly, an intriguing detail caught "
...
def finding_the_killer():
    ...
    if ch == "1":
        ...
        print("Your total score is: " + str(score + 50) + " out of 100 and you took " +
              str(current_time1 - current_time) + " to find the solution.")
        ...
        current_time1 = datetime.datetime.now()
        print("Sorry, " + x + ", you lost. Your score is " + str(score) +
              " out of 100 and you took " + str(current_time1 - current_time) +
...
def the_truth():
    print_pause("Upon closer examination, an initial "
                "observation stands out regarding Cristena's long artificial nails.")
    print_pause("It becomes evident that her nails would "
                "make it challenging for her to effectively handle a firearm.")
    print_pause("Assuming she had put on the artificial nails"
                " aboard the train, there should have been discernible marks left"
                " behind on the trigger.")
    print_pause("Alternatively, if she had changed all her "
                "fingernails, it would have raised suspicions due to noticeable marks "
                "or inconsistencies.")
    print_pause("Moreover, anyone familiar with artificial "
                "nails would be aware of her attempt to alter her appearance.")
    print_pause("Shifting focus to the other suspect, Wahid, "
                "no significant evidence has been uncovered thus far.")
    print_pause("However, upon revisiting the victim's body, a compelling "
                "detail surfaces.")
    print_pause("The victim's index finger remains the only digit that "
                "stands upright, resembling a dying message often associated with the killer.")
    print_pause("Additionally, the Arabic word for 'one' is pronounced as "
                "'Wahid,' which coincidentally shares the same spelling as the suspect's name.")
    print_pause("Furthermore, an examination of Wahid's belongings reveals a"
                " white chemical powder resembling that found in medical gloves, suggesting an attempt to wear them.")
    print_pause("The redness on his hand can be attributed to wearing these "
    ...
    print_pause("Thus, Wahid, the conclusion is unequivocal—you are the "
...
def situ2():
    ...
    print_pause("You are a detective investigating the theft of a"
...
def ask_for_sus():
    print_pause("There are only three people who could "
...
def inves_sus():
    ...
    print_pause("Ms. Sara: 'I am busy now and I have no "
    ...
    print_pause("Ms. Lana: 'Are you kidding me? A lost ring? "
...
def the_truth2():
    ...
    ch = choice()
    if ch == "1":
        print("Congratulations, " + x + "! You win. Sara is the thief because when "
                                        "you asked her about the ring, she said she didn't"
                                        " know anything about a red ring.")
        global current_time
        current_time1 = datetime.datetime.now()
        print("Your score is: " + str(score + 50) + " out of 100 and you took " 
              + str(current_time1 - current_time) + " to find the solution.")
        print("(1) Play another game?")
        print("(2) Stop playing.")
        ...
        if ch == "1":
            current_time1 = datetime.datetime.now()
            print("Sorry, " + x + ", you lose. Your score is " + str(score) +
                  " out of 100 and you took " + str(current_time1 - current_time) +
                  " to find the solution.")
            print("Sara is the thief because when you asked her"
            ...
            print("Sara is the thief because when you "
...
def show_message():
    global score
    print_pause("The message is 'Sorry I left because I think "
...
def visit_home():
    print_pause("You enter his room and find a big poster "
...
def inference():
    print_pause("After assimilating all this information,"
                " it strikes you that his room's poster"
                " prominently displayed the flag of France,"
                " which was the largest.")
    print_pause("You also recall that he has a love for football, "
                "and in the year his father passed away, 1998, France emerged as the victorious team in the World Cup, which took place in France.")
    print_pause("By piecing together these details, you come to the "
...
def eiffel():
    ...
    global current_time
    current_time1 = datetime.datetime.now()
    print("Congratulations, " + x + "! Your score is: " + str(score + 50) + " and you took "
          + str(current_time1 - current_time) + " to find the solution.")
    print()
    print_pause("Eiffel Tower is true and it means that he has"
                " a miniature model of the Eiffel Tower and the other message is inside it.")
    print_pause("Now, as you search his room once more, you"
                " come across a miniature model of the Eiffel Tower hidden in his wardrobe.")
    print_pause("To your surprise, inside the tower, you find "
                "a message that reads, 'Thank you, Mom, for always caring about me.'")
    print_pause("I'm currently on a visit to Russia to watch the"
                " final of the World Cup between France and Croatia on July 15, 2018.")
    print_pause("I will return after the event. This reminds me "
...
def letter():
    ...
    print("Sorry, " + x + ", you lost. Your score is " + str(score) +
          " and you took " + str(current_time1 - current_time) + " to find the solution.")
    print_pause("It is not true because it does not make "
                "sense that the other message is in 'France' and you ignore the word 'my biggest'.")
    print_pause("Eiffel Tower is true and it means that he has a "
                "miniature model of the Eiffel Tower and the other message is inside it.")
    print_pause("Now, as you search his room once more, you come"
                " across a miniature model of the Eiffel Tower hidden in his wardrobe.")
    print_pause("To your surprise, inside the tower, you find a "
                "message that reads, 'Thank you, Mom, for always caring about me.'")
    print_pause("I'm currently on a visit to Russia to watch "
                "the final of the World Cup between France and Croatia on July 15, 2018.")
    print_pause("I will return after the event. This reminds me of"
